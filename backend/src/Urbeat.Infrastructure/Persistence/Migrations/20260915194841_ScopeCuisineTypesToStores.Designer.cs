...
namespace Urbeat.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260915194841_ScopeCuisineTypesToStores")]
    partial class ScopeCuisineTypesToStores
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Urbeat.Domain.Entities.CuisineType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAtUtc = new DateTime(2026, 7, 28, 23, 47, 40, 0, DateTimeKind.Utc),
                            IsActive = true,
                            IsDefault = true,
                            Name = "Açaiteria",
                            NormalizedName = "acaiteria"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            NormalizedName = "comida japonesa"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            NormalizedName = "comida mexicana"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            NormalizedName = "sucos e vitaminas"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Urbeat.Domain.Entities.CustomerPhoneVerification", b =>
                {
                    ...
                    b.Property<string>("PendingComplement")
                        .HasMaxLength(120)
                        .HasColumnType("character varying(120)");

                    b.Property<string>("PendingNeighborhood")
                        .IsRequired()
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)");

                    b.Property<string>("PendingNumber")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
                    ...
                    b.Property<string>("PendingStreet")
                        .IsRequired()
                        .HasMaxLength(120)
                        .HasColumnType("character varying(120)");
            ...
            modelBuilder.Entity("Urbeat.Domain.Entities.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Urbeat.Domain.Entities.PrinterPreset", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAtUtc = new DateTime(2026, 7, 30, 0, 0, 0, 0, DateTimeKind.Utc),
            ...
            modelBuilder.Entity("Urbeat.Domain.Entities.ProductAdditional", b =>
                {
                    ...
                    b.Property<Guid?>("StoreAdditionalId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Urbeat.Domain.Entities.ProductOptionGroupTemplate", b =>
                {
                    ...
                    b.ToTable("ProductOptionGroupTemplates");
                });
            ...
            modelBuilder.Entity("Urbeat.Domain.Entities.ProductOptionItemTemplate", b =>
                {
                    ...
                    b.ToTable("ProductOptionItemTemplates");
                });
            ...
            modelBuilder.Entity("Urbeat.Domain.Entities.StoreBusinessHourShift", b =>
                {
                    ...
                    b.Property<Guid>("StoreBusinessHourId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Urbeat.Domain.Entities.StorePrinterConfig", b =>
                {
                    ...
                    b.Property<bool>("HighlightOrderNumber")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("PrintCounterCopy")
                        .HasColumnType("boolean");

                    b.Property<bool>("PrintCustomerReceipt")
                        .HasColumnType("boolean");
                    ...
                    b.Property<Guid>("PrinterPresetId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Urbeat.Domain.Entities.CuisineType", b =>
                {
                    b.HasOne("Urbeat.Domain.Entities.Store", "Store")
                        .WithMany()
            ...
            modelBuilder.Entity("Urbeat.Domain.Entities.ProductAdditional", b =>
                {
                    b.HasOne("Urbeat.Domain.Entities.Product", "Product")
                        .WithMany("Additionals")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Urbeat.Domain.Entities.StoreAdditional", "StoreAdditional")
                        .WithMany()
                        .HasForeignKey("StoreAdditionalId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Product");

                    b.Navigation("StoreAdditional");
                });

            modelBuilder.Entity("Urbeat.Domain.Entities.ProductAdditionalAssignment", b =>
                {
                    b.HasOne("Urbeat.Domain.Entities.StoreAdditional", "Additional")
            ...
            modelBuilder.Entity("Urbeat.Domain.Entities.ProductWeightConfig", b =>
                {
                    b.HasOne("Urbeat.Domain.Entities.Product", null)
                        .WithOne("WeightConfig")
                        .HasForeignKey("Urbeat.Domain.Entities.ProductWeightConfig", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Urbeat.Domain.Entities.StoreAdditional", b =>
                {
                    b.HasOne("Urbeat.Domain.Entities.StoreAdditionalGroup", "Group")
                        .WithMany("Additionals")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Urbeat.Domain.Entities.StoreBusinessHourShift", b =>
                {
                    b.HasOne("Urbeat.Domain.Entities.StoreBusinessHour", null)
                        .WithMany("Shifts")
                        .HasForeignKey("StoreBusinessHourId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
